...
| `BROTLI_COMPRESSION_DISABLE_ON_AUTH` | If set to `true`, disable Brotli compression for authenticated requests with `Cookie`, `Authorization`, or `X-Csrf-Token` headers. | `false` |
